  ...
  const hero = (title: string) => (
    <section className="pt-32 md:pt-40 pb-12 md:pb-16 bg-brand-500 text-surface">
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <p data-i18n={i18nAttr('Insights · Media')} className="text-xs md:text-sm uppercase tracking-widest font-medium text-surface/80 mb-3">Insights · Media</p>
    ...
    return (
      <>
        ...
        <div className="mx-auto max-w-screen-md px-4 md:px-8 py-12 md:py-16">
          <p data-i18n={i18nAttr('The item you are looking for may have been moved or unpublished.')} className="text-base text-ink/75 leading-relaxed">
          ...
          >
            <span aria-hidden="true">←</span> <span data-i18n={i18nAttr('Back to Media')}>Back to Media</span>
          </a>
        </div>
      </>
    );
